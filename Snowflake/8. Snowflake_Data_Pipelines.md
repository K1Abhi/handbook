...
This video discusses how to implement **batch and streaming data ingestion** from a transactional source system (typically OLTP) into Snowflake using **Change Data Capture (CDC)**.
